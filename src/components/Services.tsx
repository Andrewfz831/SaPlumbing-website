...
const Services: React.FC<SectionProps> = (props) => {
  ...
  return (
    ...
    // </>
    <>
      <div className="flex flex-col items-center bg-blue-50 m-3 w-96 border shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-lg hover:shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] duration-100">
        <div className=" w-fit mx-5 mt-5">
